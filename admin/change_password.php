...
<form action="change_password.php" method="post">
	<table cellpadding="1" cellspacing="1" width="100%">
		...
		<tr>
			...
			<td><input type="password" name="new" pattern="[A-Za-z']+" maxlength="20" required></td>
		</tr>
		<tr>
			<td>Re-Enter New Password</td>
			<td><input type="password" name="renew" pattern="[A-Za-z']+" maxlength="20" required></td>
		</tr>
		<tr>
			<td></td>
			<td><input style="width:138px" id="static" type="submit" name="change" value="Change"></td>			
		</tr>
	</table>
</form>
</body>
